...
def get_parser():
  parser = argparse.ArgumentParser(prog='theia.cli.simulate', description='Simulate events (debugging)')
  ...
  parser.add_argument('-c', dest='content', default=None, help='Use this event content instead of random content.')
  parser.add_argument('--content-size', dest='content_size', type=int, default=None, help='Size of content (approximately)')
  parser.add_argument('--delay', dest='delay', default=1.0, type=float, help='Delay between event in seconds')
