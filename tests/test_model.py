...
class TestEventSerializer(TestCase):
  ...
  def test_serialize_event(self):
    ev_str = EventSerializer().serialize(Event(id='id1',source='env1', tags=['a', 'b'], content='TEST EVENT'))
    expected = ['event: 68 58 10', 'id:id1','timestamp:','source:env1','tags:a,b','TEST EVENT']
    i = 0
  ...
  def test_parse_event(self):
    event_str = '\n'.join(['event: 68 58 10', 'id:id1','timestamp: 1491580705.9789374','source:env1','tags:a,b','TEST EVENT'])
    parser = EventParser()
